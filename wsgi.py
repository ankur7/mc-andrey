...
@app.route('/')
def reroute():
  return '<h3>Please enter the number of lines to generate, like <br><pre>http://mc-andrey.aws.af.cm/10</pre></h3><h4>Disclaimer: lyrics have not been filtered for content</h4>'
@app.route('/<lines>')
